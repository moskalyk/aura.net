...
export function register(...args: RegisterParams): RegisterResult {
    return callFunction$$(
        args,
        {
...
export function alignShare(...args: AlignShareParams): AlignShareResult {
    return callFunction$$(
        args,
        {
...
export function signIn(...args: SignInParams): SignInResult {
    return callFunction$$(
        args,
        {
    "functionName": "signIn",
...
export function writeAuraShare(...args: WriteAuraShareParams): WriteAuraShareResult {
    return callFunction$$(
        args,
        {
